...
export const experience: ExperienceItem[] = [
  {
    org: "CIBC US — Corporate Security",
    dept: "$200B+ financial institution",
    ...
    bullets: [
      ...
      [
        ...
        " as the sole data-literate resource — data models from highly unstructured sources plus ",
      ...
      [
        ...
        " — owns quarterly executive presentations and Power BI scorecards, facilitating C-suite reviews across Corporate Security, HR and IT.",
      ],
    ],
  },
  {
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    blurb: "A fleet of self-built scheduled agents — ETH price alerts, a daily news brief, a job radar, and an email → Notion application tracker — orchestrated on Claude Code.",
